  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-16 text-center">
      ...
      <p className="mt-3 text-white/70">
        We’ll email you shortly to kick things off
        {pkg ? ` for the ${pkg.replace("-", " ")} package` : ""}.
      </p>
      <a
        href="/"
        className="mt-8 inline-flex rounded-md bg-emerald-600 px-4 py-2 font-semibold text-white hover:bg-emerald-500"
      >
        Back to home
      </a>
    </main>
